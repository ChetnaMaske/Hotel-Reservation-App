        ...
        <div className="container">
          <div className="row g-5 align-items-center">
            <div className="col-lg-6">
              ...
              <h1 className="mb-4">
                Welcome to{" "}
                <span className="text-primary text-uppercase">Cloud Inn</span>
              </h1>
              <p className="mb-4">
            ...
            <div className="col-lg-6">
              <div className="row g-3">
                ...
                <div className="col-6 text-start">
                  <img
                    className="img-fluid rounded h-100 wow zoomIn"
                    data-wow-delay="0.3s"
                    src="/assets/img/About-C.jpeg"
                  />
                </div>
                <div className="col-6 text-end">
                  <img
                    className="img-fluid rounded w-51 wow zoomIn"
                    data-wow-delay="0.5s"
                    src="/assets/img/About-D.webp"
                  />
                </div>
                <div className="col-6 text-start">
                  <img
